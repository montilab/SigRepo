#' Transcriptomic signature: Myc haploinsufficient mouse liver (Myc(+/-), version 4)
#'
...
#' array-based transcriptomic platform. This dataset corresponds to version 4 of the
...
#'       \item \code{signature_name}: Signature name: \code{"Myc_reduce_mice_liver_24m_v4"}.
...
#'
#' @details
#' The \strong{Myc_reduce_mice_liver_24m_v4} signature represents age-associated
