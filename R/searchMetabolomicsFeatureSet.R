...
#' @description Search for a list of metabolomics features in the database
...
#' \dontrun{
#'
#' # Search for a list of metabolomics features in the database
#' SigRepo::searchMetabolomicsFeatureSet(
