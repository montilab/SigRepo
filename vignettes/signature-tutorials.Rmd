...
This tutorial will go over how to interect with the core of the SigRepo package. 
If you have not established a connection handler, please navigate to the 
[readme](https://github.com/montilab/SigRepo) on github to setup an account and create your connection handler in R-Studio.
