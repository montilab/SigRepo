...
#> Finished uploading.
#> ID of the uploaded signature: 1439
```
...
#> Adding signature feature set to the database...
#> Finished uploading.
#> ID of the uploaded signature: 1440
```
...
| signature_id | signature_name | organism | direction_type | assay_type | phenotype | platform_name | sample_type | covariates | description | score_cutoff | logfc_cutoff | p_value_cutoff | adj_p_cutoff | cutoff_description | keywords | PMID | year | others | has_difexp | num_of_difexp | num_up_regulated | num_down_regulated | user_name | date_created | visibility | signature_hashkey |
|---:|:---|:---|:---|:---|:---|:---|:---|:---|:---|---:|---:|---:|---:|:---|:---|---:|---:|:---|---:|---:|---:|---:|:---|:---|---:|:---|
| 1439 | LLFS_Aging_Gene_2023 | Homo sapiens | bi-directional | transcriptomics | Aging | transcriptomics by array | blood | sex,fc,education,percent_intergenic,PC1-4,GRM | NA | 6 | NA | NA | 0.01 | NA | human,aging,LLFS | NA | 2023 | NA | 1 | 1000 | 82 | 87 | montilab | 2026-01-14 23:08:23 | 1 | b35b7c1d387440d474bfcb3cb162c9a6 |
...
#> Remove difexp belongs to signature_id = '1439' from the database.
#> Remove signature_id = '1439' from 'signatures' table of the database.
#> Remove features belongs to signature_id = '1439' from 'signature_feature_set' table of the database.
#> Remove user access to signature_id = '1439' from 'signature_access' table of the database.
#> Remove signature_id = '1439' from 'signature_collection_access' table of the database.
#> signature_id = '1439' has been removed.
```
...
#>   [Success] OmicSignature object Myc_reduce_mice_liver_24m_readme created.
#> signature_id = '1440' has been updated.
```
...
#> Remove difexp belongs to signature_id = '1440' from the database.
#> Remove signature_id = '1440' from 'signatures' table of the database.
#> Remove features belongs to signature_id = '1440' from 'signature_feature_set' table of the database.
#> Remove user access to signature_id = '1440' from 'signature_access' table of the database.
#> Remove signature_id = '1440' from 'signature_collection_access' table of the database.
#> signature_id = '1440' has been removed.
```
