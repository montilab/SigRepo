...
corresponds to version 4 of the `Myc_reduce_mice_liver_24m` signature
series.
...
- Metadata:
  ...
  - `signature_name`: Signature name: `"Myc_reduce_mice_liver_24m_v4"`.
...
The **Myc_reduce_mice_liver_24m_v4** signature represents age-associated
