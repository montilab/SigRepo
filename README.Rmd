...
Please navigate to our sigrepo.org portal to create your account. On the login page you can click register user. Please click on this and fill out the form. You will recieve an email when your account has been activated. Due to SQL contstraints, having multiple users on the same testing account, like running the tutorial in the readme, will fail to connect. Each user using their own account is ideal.
