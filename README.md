...
#>  ID of the uploaded signature: 521
```
...
#> Adding signature feature set to the database...
#> Finished uploading.
#> ID of the uploaded signature: 523
```
...
| signature_id | signature_name | organism | direction_type | assay_type | phenotype | platform_name | sample_type | covariates | description | score_cutoff | logfc_cutoff | p_value_cutoff | adj_p_cutoff | cutoff_description | keywords | PMID | year | others | has_difexp | num_of_difexp | num_up_regulated | num_down_regulated | user_name | date_created | visibility | signature_hashkey |
|---:|:---|:---|:---|:---|:---|:---|:---|:---|:---|---:|---:|---:|---:|:---|:---|---:|---:|:---|---:|---:|---:|---:|:---|:---|---:|:---|
| 521 | LLFS_Aging_Gene_2023 | Homo sapiens | bi-directional | transcriptomics | Aging | transcriptomics by array | blood | sex,fc,education,percent_intergenic,PC1-4,GRM | NA | 6 | NA | NA | 0.01 | NA | human,aging,LLFS | NA | 2023 | NA | 1 | 1000 | 82 | 87 | montilab | 2025-10-21 03:34:37 | 0 | b35b7c1d387440d474bfcb3cb162c9a6 |
...
#> Remove difexp belongs to signature_id = '521' from the database.
#> Remove signature_id = '521' from 'signatures' table of the database.
#> Remove features belongs to signature_id = '521' from 'signature_feature_set' table of the database.
#> Remove user access to signature_id = '521' from 'signature_access' table of the database.
#> Remove signature_id = '521' from 'signature_collection_access' table of the database.
#> signature_id = '521' has been removed.
```
...
#>   [Success] OmicSignature object Myc_reduce_mice_liver_24m_readme created.
#>  signature_id = '523' has been updated.
```
...
| signature_id | signature_name | organism | direction_type | assay_type | phenotype | platform_name | sample_type | covariates | description | score_cutoff | logfc_cutoff | p_value_cutoff | adj_p_cutoff | cutoff_description | keywords | PMID | year | others | has_difexp | num_of_difexp | num_up_regulated | num_down_regulated | user_name | date_created | visibility | signature_hashkey |
|---:|:---|:---|:---|:---|:---|:---|:---|:---|:---|---:|---:|---:|---:|:---|:---|---:|---:|:---|---:|---:|---:|---:|:---|:---|---:|:---|
| 523 | Myc_reduce_mice_liver_24m_readme | Mus musculus | bi-directional | transcriptomics | Myc_reduce | transcriptomics by single-cell RNA-seq | liver | none | mice Myc haploinsufficient (Myc(+/-)) | 5 | NA | NA | 0.05 | NA | Myc, KO, longevity | 25619689 | 2015 | animal_strain: \<C57BL/6\> | 1 | 884 | 5 | 10 | montilab | 2025-10-21 04:17:56 | 0 | a10176ce6e727366cf740e2bfb56e2bc |
...
#> Remove difexp belongs to signature_id = '523' from the database.
#> Remove signature_id = '523' from 'signatures' table of the database.
#> Remove features belongs to signature_id = '523' from 'signature_feature_set' table of the database.
#> Remove user access to signature_id = '523' from 'signature_access' table of the database.
#> Remove signature_id = '523' from 'signature_collection_access' table of the database.
#> signature_id = '523' has been removed.
```
